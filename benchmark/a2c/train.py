...
from rltoolkit.utils.time_stat import TimeStat
from rltoolkit.utils.window_stat import WindowStat
...
class Learner(object):
    ...
    def log_metrics(self):
        ...
        max_episode_rewards, mean_episode_rewards, min_episode_rewards, max_episode_steps, \
            mean_episode_steps, min_episode_steps = None, None, None, None, None, None
        if episode_rewards:
