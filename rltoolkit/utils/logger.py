'''
Author: jianzhnie
Date: 2022-09-01 15:31:02
LastEditors: jianzhnie
LastEditTime: 2022-09-01 15:31:10
Description:
...
def _getlogger():
    logger = logging.getLogger('rltoolkit')
    logger.propagate = False
    logger.setLevel(logging.DEBUG)

    if 'DEBUG' in os.environ:
        handler = logging.FileHandler('rltoolkit_debug.log')
...
def auto_set_dir(action=None):
    """Set the global logging directory automatically. The default path is
    "./train_log/{scriptname}". "scriptname" is the name of the main python
...
mod = sys.modules['__main__']
if hasattr(mod, '__file__') and 'Xrltoolkit' not in os.environ:
